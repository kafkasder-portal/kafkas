  ...
  const loadScholarships = async () => {
    try {
      ...
      const activeScholarships = data.filter(
        scholarship => scholarship.status === 'Aktif'
      ).length;
      const graduates = data.filter(
        scholarship => scholarship.year === 4
      ).length;
      ...
      >
        <div>
          ...
          <p style={{ color: '#64748b', margin: '0.5rem 0 0 0' }}>
            Öğrenci bursları ve eğitim destekleri
          </p>
        </div>
            ...
            {filteredScholarships.map(scholarship => (
              ...
              >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <span
                            style={{
                              color: getGpaColor(scholarship.gpa),
                              fontWeight: '600',
                            }}
                          >
                            {scholarship.gpa}
                ...
                <div style={{ display: 'flex', gap: '0.5rem' }}>
                  ...
                  <motion.button
                    onClick={() =>
                      handleUpdateScholarship(scholarship.id, {
