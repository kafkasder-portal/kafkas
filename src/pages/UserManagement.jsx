...
const UserManagement = () => {
  const { users, addUser, updateUser, deactivateUser, getRoleName, ROLES } = useAuth()
  ...
  const handleDeactivateUser = async (user) => {
    if (window.confirm(`${user.fullName} kullanıcısını deaktif etmek istediğinize emin misiniz?`)) {
      try {
                  ...
                  >
                    ...
                    <td style={{ padding: '1rem' }}>
                      <span style={{
                        ...
                        fontSize: '0.75rem',
                        fontWeight: '600',
                        backgroundColor: user.role === ROLES.ADMIN ? '#fee2e2' :
                          user.role === ROLES.MODERATOR ? '#fef3c7' : '#e0e7ff',
                        color: user.role === ROLES.ADMIN ? '#dc2626' :
                          user.role === ROLES.MODERATOR ? '#d97706' : '#6366f1'
                      }}>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        style={{
                          width: '100%',
                          padding: '0.75rem',
                          border: form.errors.username && form.touched.username ? '1px solid #ef4444' : '1px solid #e5e7eb',
                          borderRadius: '8px'
                        }}
                      />
                      ...
                      <div style={{ position: 'relative' }}>
                        <input
                          ...
                          style={{
                            ...
                            padding: '0.75rem',
                            paddingRight: '2.5rem',
                            border: form.errors.password && form.touched.password ? '1px solid #ef4444' : '1px solid #e5e7eb',
                            borderRadius: '8px'
                          }}
                        />
                        <button
                    ...
                    <div>
                      ...
                      <input
                        ...
                        style={{
                          width: '100%',
                          padding: '0.75rem',
                          border: form.errors.email && form.touched.email ? '1px solid #ef4444' : '1px solid #e5e7eb',
                          borderRadius: '8px'
                        }}
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        style={{
                          width: '100%',
                          padding: '0.75rem',
                          border: form.errors.fullName && form.touched.fullName ? '1px solid #ef4444' : '1px solid #e5e7eb',
                          borderRadius: '8px'
                        }}
                      />
                  ...
                  <div style={{ display: 'flex', gap: '1rem', marginTop: '1.5rem' }}>
                    <motion.button
                      ...
                      style={{
                        flex: 1,
                        padding: '0.75rem',
                        backgroundColor: form.isSubmitting ? '#9ca3af' : '#3b82f6',
                        color: 'white',
                        border: 'none',
                        borderRadius: '8px',
                        fontWeight: '600',
                    ...
                    >
                      {form.isSubmitting ? 'Kaydediliyor...' : (editingUser ? 'Güncelle' : 'Ekle')}
                    </motion.button>
                    <motion.button
                      type="button"
                      onClick={handleCloseModal}
