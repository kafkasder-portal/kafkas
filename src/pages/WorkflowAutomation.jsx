...
const WorkflowAutomation = () => {
  ...
  const mockWorkflows = [
    {
      ...
      description:
        'Yeni bağışları otomatik olarak onaylar ve teşekkür e-postası gönderir',
      status: 'active',
  ...
  const mockExecutions = [
    ...
    },
    {
      ...
      steps: [
        {
          name: 'Gönüllü Eşleşme',
          status: 'failed',
          duration: 5000,
          error: 'Uygun gönüllü bulunamadı',
        },
  ...
  const WorkflowBuilder = () => {
    ...
    const availableTriggers = [
      {
        ...
        name: 'Yeni Bağış',
        icon: Target,
        description: 'Yeni bağış geldiğinde',
      },
      {
        id: 'new_volunteer',
        name: 'Yeni Gönüllü',
        icon: Users,
        description: 'Yeni gönüllü kaydında',
      },
      {
        id: 'task_completed',
        name: 'Görev Tamamlandı',
        icon: CheckCircle,
        description: 'Görev tamamlandığında',
      },
      {
        id: 'event_created',
        name: 'Etkinlik Oluşturuldu',
        icon: Calendar,
        description: 'Yeni etkinlik oluşturulduğunda',
      },
      {
        id: 'scheduled',
        name: 'Zamanlı',
        icon: Clock,
        description: 'Belirli zamanlarda',
      },
    ];
    ...
    const availableActions = [
      ...
      },
      {
        ...
        icon: Bell,
        description: 'Sistem bildirimi gönder',
      },
      {
        id: 'update_database',
        name: 'Veritabanı Güncelle',
        icon: Database,
        description: 'Veritabanını güncelle',
      },
      {
        id: 'assign_task',
        name: 'Görev Ata',
        icon: Target,
        description: 'Gönüllüye görev ata',
      },
      {
        id: 'create_record',
        name: 'Kayıt Oluştur',
      ...
      },
      {
        ...
        icon: Code,
        description: 'Özel script çalıştır',
      },
    ];
                ...
                style={{
                  ...
                  backgroundColor:
                    builderStep === step
                      ? '#667eea'
                      : index <
                          ['trigger', 'action', 'review'].indexOf(builderStep)
                        ? '#10b981'
                        : '#e5e7eb',
                  color: 'white',
                  display: 'flex',
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
          <motion.button
            ...
            style={{
              ...
              backgroundColor:
                builderStep === 'trigger' ? '#e5e7eb' : '#6b7280',
              color: 'white',
              border: 'none',
              borderRadius: '8px',
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <tbody>
            {executionHistory.map(execution => {
              ...
              const statusColor =
                execution.status === 'success' ? '#10b981' : '#ef4444';
              const StatusIcon =
                execution.status === 'success' ? CheckCircle : AlertCircle;
  ...
  return (
    <div className='page-container'>
      ...
      >
        <div>
          ...
          <p className='page-subtitle'>
            İş süreçlerinizi otomatikleştirin ve verimliliği artırın
          </p>
        </div>
        <div style={{ display: 'flex', gap: '0.5rem' }}>
          <motion.button
      ...
      {/* Workflow Builder */}
      <AnimatePresence>{isCreating && <WorkflowBuilder />}</AnimatePresence>
