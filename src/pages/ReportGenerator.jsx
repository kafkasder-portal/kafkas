  ...
  return (
    <div className="page-container">
      ...
      >
        ...
        <p className="page-subtitle">Detaylı raporlar oluşturun ve analiz edin</p>
      </motion.div>
              ...
              >
                ...
                <div style={{ 
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: '0.875rem', color: '#6b7280', margin: 0 }}>
                      Oluşturulma: {generatedReport.generatedAt.toLocaleDateString('tr-TR')}
                    </p>
                  </div>
                  ...
                  <div>
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1rem', marginBottom: '2rem' }}>
                      <div style={{ textAlign: 'center', padding: '1rem', backgroundColor: '#f8fafc', borderRadius: '8px' }}>
                        ...
                        <div style={{ fontSize: '0.875rem', color: '#6b7280' }}>Toplam Bağış</div>
                      </div>
                      <div style={{ textAlign: 'center', padding: '1rem', backgroundColor: '#f8fafc', borderRadius: '8px' }}>
                        <div style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#3b82f6' }}>
                          {generatedReport.data.count}
                        </div>
                        <div style={{ fontSize: '0.875rem', color: '#6b7280' }}>Bağış Sayısı</div>
                      </div>
                      <div style={{ textAlign: 'center', padding: '1rem', backgroundColor: '#f8fafc', borderRadius: '8px' }}>
                  ...
                  <div>
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1rem', marginBottom: '2rem' }}>
                      <div style={{ textAlign: 'center', padding: '1rem', backgroundColor: '#f8fafc', borderRadius: '8px' }}>
                        ...
                        <div style={{ fontSize: '0.875rem', color: '#6b7280' }}>Toplam Gönüllü</div>
                      </div>
                      <div style={{ textAlign: 'center', padding: '1rem', backgroundColor: '#f8fafc', borderRadius: '8px' }}>
                        <div style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#10b981' }}>
                          {generatedReport.data.active}
                        </div>
                        <div style={{ fontSize: '0.875rem', color: '#6b7280' }}>Aktif</div>
                      </div>
                      <div style={{ textAlign: 'center', padding: '1rem', backgroundColor: '#f8fafc', borderRadius: '8px' }}>
                        <div style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#f59e0b' }}>
                          {generatedReport.data.hours}
                        </div>
                        <div style={{ fontSize: '0.875rem', color: '#6b7280' }}>Toplam Saat</div>
                      </div>
                    </div>
                  </div>
                )}
