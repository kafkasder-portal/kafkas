...
const HospitalReferral = () => {
  ...
  useEffect(() => {
    ...
    let filtered = referrals.filter(referral => {
      const matchesSearch = searchTerm === '' || 
        ...
        referral.referredHospital?.toLowerCase().includes(searchTerm.toLowerCase())
  ...
  const handleStatusChange = async (referralId, newStatus) => {
    try {
      await hospitalReferralsService.updateReferralStatus(referralId, newStatus)
  ...
  // Pagination
  const safeFilteredReferrals = Array.isArray(filteredReferrals) ? filteredReferrals : []
    ...
    >
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
          ...
          {subtitle && (
            <p style={{ fontSize: '0.75rem', color: color, margin: '0.25rem 0 0 0', fontWeight: '500' }}>
              {subtitle}
            </p>
          )}
        </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1rem' }}>
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.5rem' }}>
            ...
            <span style={{ fontSize: '0.875rem', color: '#6b7280' }}>Tanı:</span>
          </div>
        ...
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.5rem' }}>
            ...
            <span style={{ fontSize: '0.875rem', color: '#6b7280' }}>Hastane:</span>
          </div>
          <p style={{ fontSize: '0.875rem', fontWeight: '500', color: '#374151', margin: 0 }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingTop: '1rem', borderTop: '1px solid #f3f4f6' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
          ...
          {referral.transportNeeded && (
            <Ambulance size={14} color="#3b82f6" />
          )}
        </div>
      </div>
    </motion.div>
          ...
          <div style={{ padding: '1.5rem' }}>
            ...
            <div style={{ marginBottom: '2rem' }}>
              ...
              <div style={{ 
                ...
                <div>
                  <span style={{ fontSize: '0.75rem', color: '#6b7280', display: 'block' }}>Ad Soyad</span>
                  <span style={{ fontSize: '0.875rem', fontWeight: '500' }}>{selectedReferral.patientName}</span>
                </div>
                <div>
                  <span style={{ fontSize: '0.75rem', color: '#6b7280', display: 'block' }}>TC Kimlik</span>
                  <span style={{ fontSize: '0.875rem', fontWeight: '500' }}>{selectedReferral.nationalId}</span>
                </div>
                <div>
                  <span style={{ fontSize: '0.75rem', color: '#6b7280', display: 'block' }}>Yaş</span>
                  <span style={{ fontSize: '0.875rem', fontWeight: '500' }}>{selectedReferral.age}</span>
                </div>
                <div>
                  <span style={{ fontSize: '0.75rem', color: '#6b7280', display: 'block' }}>Cinsiyet</span>
                  <span style={{ fontSize: '0.875rem', fontWeight: '500' }}>{selectedReferral.gender}</span>
                </div>
                <div style={{ gridColumn: '1 / -1' }}>
                  <span style={{ fontSize: '0.75rem', color: '#6b7280', display: 'block' }}>Adres</span>
                  <span style={{ fontSize: '0.875rem', fontWeight: '500' }}>{selectedReferral.address}</span>
                </div>
              </div>
            </div>
            ...
            <div style={{ marginBottom: '2rem' }}>
              ...
              <div style={{ 
                ...
                <div>
                  <span style={{ fontSize: '0.75rem', color: '#6b7280', display: 'block' }}>Tanı</span>
                  <span style={{ fontSize: '0.875rem', fontWeight: '500' }}>{selectedReferral.diagnosis}</span>
                </div>
                <div>
                  <span style={{ fontSize: '0.75rem', color: '#6b7280', display: 'block' }}>Aciliyet</span>
                  <div style={{
                ...
                <div>
                  <span style={{ fontSize: '0.75rem', color: '#6b7280', display: 'block' }}>Hastane</span>
                  <span style={{ fontSize: '0.875rem', fontWeight: '500' }}>{selectedReferral.referredHospital}</span>
                </div>
                <div>
                  <span style={{ fontSize: '0.75rem', color: '#6b7280', display: 'block' }}>Bölüm</span>
                  <span style={{ fontSize: '0.875rem', fontWeight: '500' }}>{selectedReferral.referredDepartment}</span>
                </div>
                <div>
                  <span style={{ fontSize: '0.75rem', color: '#6b7280', display: 'block' }}>Doktor</span>
                  <span style={{ fontSize: '0.875rem', fontWeight: '500' }}>{selectedReferral.doctorName}</span>
                </div>
                <div>
                  <span style={{ fontSize: '0.75rem', color: '#6b7280', display: 'block' }}>Randevu Tarihi</span>
                  <span style={{ fontSize: '0.875rem', fontWeight: '500' }}>
                    {formatDate(selectedReferral.appointmentDate)}
                  </span>
                </div>
                <div style={{ gridColumn: '1 / -1' }}>
                  <span style={{ fontSize: '0.75rem', color: '#6b7280', display: 'block' }}>Notlar</span>
                  <span style={{ fontSize: '0.875rem', fontWeight: '500' }}>{selectedReferral.notes}</span>
                </div>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div style={{ display: 'flex', gap: '0.5rem' }}>
                <motion.button
                  onClick={() => handleStatusChange(selectedReferral.id, 'approved')}
                  style={{
                    display: 'flex',
                    alignItems: 'center',
                    gap: '0.5rem',
                ...
                <motion.button
                  onClick={() => handleStatusChange(selectedReferral.id, 'rejected')}
                  style={{
                    display: 'flex',
                    alignItems: 'center',
                    gap: '0.5rem',
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                ...
                {selectedReferral.transportNeeded && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.25rem' }}>
                    ...
                    <span style={{ fontSize: '0.75rem', color: '#3b82f6' }}>Ulaşım</span>
                  </div>
                )}
              </div>
            </div>
    ...
    <div className="page-container">
      ...
      >
        <div>
          ...
          <p className="page-subtitle">Hasta sevk işlemlerini yönetin ve takip edin</p>
        </div>
        <div style={{ display: 'flex', gap: '0.5rem' }}>
          <motion.button
      ...
      >
        {loading ? (
          ...
          <div style={{ textAlign: 'center', padding: '3rem 0' }}>
            <Stethoscope size={48} color="#9ca3af" style={{ margin: '0 auto 1rem' }} />
            <h3 style={{ fontSize: '1.125rem', fontWeight: '500', color: '#111827', marginBottom: '0.5rem' }}>Sevk bulunamadı</h3>
