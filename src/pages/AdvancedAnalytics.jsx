...
const AdvancedAnalytics = () => {
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            <div
              style={{
                ...
                backgroundColor:
                  trend.trend === 'up' ? '#10b98115' : '#ef444415',
                borderRadius: '12px',
  ...
  const SimpleLineChart = ({ data, metric, color }) => {
    ...
    const getY = value =>
      padding +
      (1 - (value - minValue) / (maxValue - minValue)) * (height - padding * 2);
    ...
    <div className='page-container'>
      ...
      >
        <div>
          ...
          <p className='page-subtitle'>
            Detaylı veri analizi ve performans metrikleri
          </p>
        </div>
          ...
          {timeRanges.map(range => (
            <motion.button
              ...
              style={{
                padding: '0.5rem 1rem',
                backgroundColor:
                  selectedTimeRange === range.id ? '#667eea' : 'rgba(0,0,0,0)',
      ...
      >
        ...
        >
          ...
          {data && (
            <SimpleLineChart data={data} metric='donations' color='#10b981' />
          )}
        </motion.div>
          ...
          <div style={{ textAlign: 'center', padding: '2rem 0' }}>
            <motion.div
              style={{
                ...
                borderRadius: '50%',
                background:
                  'conic-gradient(from 0deg, #10b981 0deg 252deg, #e5e7eb 252deg 360deg)',
                display: 'flex',
                alignItems: 'center',
