...
import { Award, Clock, Filter, Mail, MapPin, Phone, Plus, Search, UserPlus, Users } from 'lucide-react'
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
        <div>
          <h1 style={{ fontSize: '2rem', fontWeight: '700', color: '#1a202c', margin: 0 }}>Gönüllü Yönetimi</h1>
          <p style={{ color: '#64748b', margin: '0.5rem 0 0 0' }}>Gönüllü kayıtları ve aktivite takibi</p>
        </div>
        <motion.button
          style={{
            display: 'flex',
      ...
      {/* Gönüllü Listesi */}
      <div className="card">
        <h3 style={{ fontSize: '1.25rem', fontWeight: '600', color: '#1a202c', marginBottom: '1.5rem' }}>Gönüllü Listesi</h3>
        ...
        {loading && (
          <div style={{ textAlign: 'center', padding: '2rem' }}>
            ...
            <p style={{ marginTop: '1rem', color: '#64748b' }}>Gönüllüler yükleniyor...</p>
          </div>
        )}
              ...
              >
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1rem' }}>
                  <div style={{ flex: 1 }}>
                    ...
                    <p style={{ color: '#667eea', fontWeight: '500', margin: '0 0 0.5rem 0', fontSize: '0.875rem' }}>
                      {volunteer.role}
                    </p>
                ...
                <div style={{ display: 'flex', gap: '0.5rem' }}>
                  <motion.button
                    onClick={() => handleUpdateVolunteer(volunteer.id, { status: volunteer.status === 'Aktif' ? 'Pasif' : 'Aktif' })}
                    style={{
                      padding: '0.5rem 1rem',
                      backgroundColor: '#3b82f6',
                      color: 'white',
                  ...
                  <motion.button
                    onClick={() => handleUpdateVolunteer(volunteer.id, { hoursWorked: volunteer.hoursWorked + 1 })}
                    style={{
                      padding: '0.5rem 1rem',
