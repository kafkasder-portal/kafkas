...
import { Brain, Calendar, Coins, Lightbulb, TrendingUp, Users } from 'lucide-react'
    ...
    general: [
      {
        ...
        description: 'Son 30 günde bağış oranları %15 düştü. Yeni kampanya başlatmanızı öneriyoruz.',
        priority: 'high',
      ...
      },
      {
        ...
        description: 'Aktif gönüllü sayınız artıyor. Yeni etkinlik planlamanızı öneriyoruz.',
        priority: 'medium',
      ...
      },
      {
        ...
        description: 'Giderleriniz %8 artmış. Maliyet kontrolü için önlem almanızı öneriyoruz.',
        priority: 'high',
        action: 'Rapor İncele',
        icon: TrendingUp,
    ...
    donations: [
      {
        ...
        description: 'Ramazan ayı yaklaşıyor. Özel bağış kampanyası başlatmanızı öneriyoruz.',
        priority: 'high',
    ...
    volunteers: [
      {
        ...
        description: 'Yeni gönüllüler için eğitim programı düzenlemenizi öneriyoruz.',
        priority: 'medium',
        ...
        {suggestions.map((suggestion, index) => {
          ...
          return (
            <motion.div
              ...
              className={`border rounded-lg p-4 mb-4 transition-all duration-200 hover:shadow-md ${selectedSuggestion?.id === suggestion.id
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <button
                        ...
                        className={`px-3 py-1 text-xs font-medium rounded-md transition-colors ${selectedSuggestion?.id === suggestion.id
                            ? 'bg-blue-100 text-blue-600 cursor-not-allowed'
                            : 'bg-blue-600 text-white hover:bg-blue-700'
                          }`}
                      >
                        {selectedSuggestion?.id === suggestion.id ? 'Uygulanıyor...' : suggestion.action}
                      </button>
                    </div>
                  </div>
                </div>
