    ...
    >
      ...
      <div className="stats-grid">
        ...
        <div className="stat-item">
          ...
          <div className="stat-content">
            <div className="stat-value">{formatNumber(stats.pendingRequests)}</div>
        ...
        <div className="stat-item">
          ...
          <div className="stat-content">
            <div className="stat-value">{formatNumber(stats.completedProjects)}</div>
...
const QuickActionsWidget = () => {
  const quickActions = [
    ...
    { id: 3, title: 'Görev Oluştur', icon: Target, color: '#f59e0b', path: '/tasks?action=create' },
  ...
  const HealthBar = ({ label, value, unit = '%' }) => (
    <div style={{ marginBottom: '1rem' }}>
      <div style={{ display: 'flex', justifyContent: 'between', alignItems: 'center', marginBottom: '0.5rem' }}>
        ...
        <span style={{ fontSize: '0.875rem', fontWeight: '600', color: getHealthColor(value) }}>
          {value}{unit}
        </span>
      </div>
      <div style={{ 
    ...
    <div className="card">
      <div style={{ display: 'flex', justifyContent: 'between', alignItems: 'center', marginBottom: '1.5rem' }}>
        ...
        <div style={{
          ...
          <span style={{ fontSize: '0.75rem', fontWeight: '500', color: '#10b981' }}>Çevrimiçi</span>
        </div>
      </div>
