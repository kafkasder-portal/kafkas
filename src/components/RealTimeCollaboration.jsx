...
const RealTimeCollaboration = ({ roomId = 'general' }) => {
  ...
  const mockMessages = [
    {
      ...
      userId: 1,
      name: 'Ahmet Yılmaz',
      message: 'Merhaba! Bugünkü toplantıya hazır mısınız?',
      timestamp: '10:30',
    },
    {
      id: 2,
      userId: 2,
      name: 'Fatma Demir',
      message: 'Evet, hazırım. Gündem maddelerini gözden geçirdim.',
      timestamp: '10:32',
    },
    {
      id: 3,
      userId: 3,
      name: 'Mehmet Kaya',
      message: 'Ben de katılıyorum. Bağış kampanyası hakkında konuşalım.',
      timestamp: '10:35',
    },
  ];
  ...
  const toggleCall = () => {
    ...
    toast.success(
      isCallActive ? 'Görüşme sonlandırıldı' : 'Görüşme başlatıldı'
    );
  };
